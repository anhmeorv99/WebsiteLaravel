<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 205 Bạch Mai, Hai Bà Trưng, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i>0988964753</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/image/logo.png" width="100px" alt=""></a>
				</div>
					...
					<div class="beta-comp">
						...
						<div class="cart">
							...
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng 
								(@if(Session::has('cart')) {{Session('cart')->totalQty}} sản phẩm 
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('loaisanpham','8')}}">Sản phẩm</a>
							<ul class="sub-menu">
